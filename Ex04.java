...
class Student extends Person {
    ...
    public Student (String id, String phone, Name name, Address address, String className) {
    ...
    public static Student setStudent() {
        ...
        scanner.close();
        return new Student(person.id, person.phone, person.name, person.address, className);
    }
}
class Faculty extends Person {
    ...
    public static Faculty setFaculty () {
        ...
        sc.close();
        return new Faculty(person.id, person.phone, person.name, person.address, job);
    }
}
class Course {
    String id, name;
...
public class Ex04 {
    ...
    public static void addStudent () {
        ...
        String data = "ID: " + student.id + ", Name: " + student.name.getName() +" ,Class:" + student.className+ ", Phone: " + student.phone + ", Address: " + student.address.getAdrress() + "\n";
    ...
    public static void addCourse() {
        ...
        courses.add(course);
        String data = "ID: " + course.id + ", Name: " + course.name + ", Credit:" + course.credit + "" + "\n";
    ...
    public static void addFaculty() {
        ...
        String data = "ID:" + faculty.id + ", Name: " + faculty.name.getName() + ", Job: " + faculty.job + ",Phone: " + faculty.phone + ",Address: " + faculty.address.getAdrress() + "\n";
